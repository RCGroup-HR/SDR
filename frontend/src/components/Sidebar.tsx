  ...
  const allMenuItems = [
    {
      ...
      items: [
        ...
        { name: 'Carga Masiva', path: '/carga-masiva', icon: '📥', modulo: 'carga_masiva' },
        { name: 'Carga Masiva de Fotos', path: '/carga-masiva-fotos', icon: '📸', modulo: 'carga_masiva_fotos' },
        { name: 'Impresión de Carnets',  path: '/impresion-carnets',  icon: '🖨️', modulo: 'impresion_carnets' },
        { name: 'Mant. Países', path: '/mantenimiento-paises', icon: '🌍', modulo: 'paises' },
        { name: 'País de Jugadores', path: '/correccion-pais-jugador', icon: '🚩', modulo: 'paises' },
